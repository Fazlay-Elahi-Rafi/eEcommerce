...
import { HiOutlineClipboardCheck, HiUserGroup } from "react-icons/hi";
        ...
        <div className="d-flex justify-content-around mb-5">
          <div className="col-5 col-lg-4 text-center">
            <a href="#" className="text-decoration-none">
              <div className="profile__info-box">
                <div className="">
                  <HiOutlineClipboardCheck className="profile__info-box--icon" />
                </div>
                <div className="">
          ...
          <div className="col-5 col-lg-4 text-center">
            <a href="#" className="text-decoration-none">
              <div className="profile__info-box">
                <div className="">
                  <TbCurrentLocation className="profile__info-box--icon" />
                </div>
                <div className="">
                  <h4 className="profile__info-box--text">orders</h4>
                </div>
        ...
        <div className="d-flex justify-content-around">
          <div className="col-5 col-lg-4 text-center">
            <a href="#" className="text-decoration-none">
              <div className="profile__info-box">
                <div className="">
                  <HiUserGroup className="profile__info-box--icon" />
                </div>
                <div className="">
